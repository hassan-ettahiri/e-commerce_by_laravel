                            ...
                            @else
                                <form action="{{ url('add-to-carte') }}" class="post-form" method="POST">
                                    ...
                                    <div class="quantity-wrapper u-s-m-b-22">
                                        <span>Quantity:</span>
                                        <div class="quantity">
                                            <input type="text" name='quantite' class="quantity-text-field" value="1" readonly>
                    ...
                    <div class="detail-tabs-wrapper u-s-p-t-80">
                        <div class="detail-nav-wrapper u-s-m-b-30">
                            <ul class="nav single-product-nav justify-content-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#review">Reviews ({{ $total_review }})</a>
                                </li>
                            </ul>
                        </div>
                                        ...
                                        <form action="{{ url('review') }}" method="POST">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="your-rating-wrapper">
                                                    ...
                                                    <input id="your-name" type="text" name="name" class="text-field" placeholder="Your Name">
